...
def _load_module():
    ...
    # numpy is a real, light dependency -- import it for real
    import numpy  # noqa: F401
    # stub training.datasets.report_save_step_distribution
    ...
    sys.modules["training.datasets"] = td
    # stub utils.load_datasets
    ...
    sys.modules["utils.load_datasets"] = ld
...
def test_amplitude_matches_closed_form():
    cnf = _load_module()
...
def test_amplitude_shrinks_toward_T0():
    cnf = _load_module()
